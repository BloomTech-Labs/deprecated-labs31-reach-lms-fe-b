...
const GET_USER_PROGRAMS_START = 'GET_USER_PROGRAMS_START';
const GET_USER_PROGRAMS_SUCCESS = 'GET_USER_PROGRAMS_SUCCESS';
const GET_USER_PROGRAMS_FAIL = 'GET_USER_PROGRAMS_FAIL';
const GET_USER_PROGRAMS_RESOLVE = 'GET_USER_PROGRAMS_RESOLVE';
